...
class _GuiScreen2State extends State<GuiScreen2> {
  ...
  bool isHidden = false;
  String
      photoFromAsset; // String photoFromUrl="";// bool hasImage=false;// bool hasPadding=false;
  List<TextEditModel> textEdits = [
    TextEditModel(text: " Text Before"),
    TextEditModel(text: "Focused Text"),
    TextEditModel(text: " Text After")
  ];
  int focusedText = 1;
        ...
        ..onTap = () {
          ...
          setState(() {
            ...
            fontSizeController.text =
                textEdits[focusedText].fontSize.toStringAsPrecision(2);
          });
        };
    }
  ...
  Color boxColor() =>
      colorFromString(map["color"]["value"] + map["shade"]["value"],
    ...
    return Row(
      children: <Widget>[
        IconButton(
          onPressed: () {
            setState(() {
              textEdits[focusedText].fw =
                  (textEdits[focusedText].fw == FontWeight.bold)
                      ? FontWeight.normal
                      : FontWeight.bold;
            });
          },
        ...
        IconButton(
          onPressed: () {
            setState(() {
              textEdits[focusedText].fs =
                  (textEdits[focusedText].fs == FontStyle.italic)
                      ? FontStyle.normal
                      : FontStyle.italic;
            });
          },
        ...
        IconButton(
          onPressed: () {
            setState(() {
              textEdits[focusedText].newLines += 1;
            });
          },
        ...
        SizedBox.fromSize(
            ...
            child: GestureDetector(
              ...
              child: Container(
                  ...
                  child: d.rootBox.toStack(d.size,
                      boxinfo: BoxInfo.fromMap(map),
                      refresh: () => setState(() {}))),
