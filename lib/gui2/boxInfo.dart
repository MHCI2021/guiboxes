...
class BoxInfo {
  ...
  Widget ifCentered(Widget w) => centered
      ? Center(
          child: w,
        )
      : w;
            ...
            decoration: BoxDecoration(
                ...
                border: decorate
                    ? Border.all(
                        ...
                        color: colorFromString(borderColor),
                      )
                    : null,
                borderRadius:
                    decorate ? BorderRadius.circular(borderRadius) : null),
            child: Padding(
                padding: EdgeInsets.all((hasPadding ? 8.0 : 0.0)),
                child: ifCentered((childType == CHILDTYPE.BOX)
                    ? child
